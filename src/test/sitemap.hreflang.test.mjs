...
describe("sitemap hreflangPair", () => {
  it("maps fa/en home and nested routes to reciprocal alternates", () => {
    expect(hreflangPair("/")).toEqual({
      fa: "https://dbsgraphic.ir/",
      en: "https://dbsgraphic.ir/en",
    });
    ...
    expect(hreflangPair("/projects/dbspulse")).toEqual({
      fa: "https://dbsgraphic.ir/projects/dbspulse",
      en: "https://dbsgraphic.ir/en/projects/dbspulse",
    });
...
describe("public/sitemap.xml xhtml hreflang", () => {
  it("declares xmlns:xhtml and emits fa/en alternates on each url", () => {
    ...
    expect(xml).toMatch(/<xhtml:link rel="alternate" hreflang="fa" href="https:\/\/dbsgraphic\.ir\/"/);
    expect(xml).toMatch(/<xhtml:link rel="alternate" hreflang="en" href="https:\/\/dbsgraphic\.ir\/en"/);
