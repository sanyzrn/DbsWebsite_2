...
const fa = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: "فرم تماس",
        body: "وقتی از طریق فرم تماس پیامی ارسال می‌کنید، نام، ایمیل، متن پیام و جزئیات اختیاری پروژه به یک endpoint هم‌مبدأ (PHP) روی همین سایت ارسال می‌شود و یک اعلان متنی ساده از طریق Telegram Bot API برای سعید زرینی فرستاده می‌شود. توکن ربات هرگز در باندل مرورگر قرار نمی‌گیرد. این اطلاعات فقط برای پاسخ به درخواست شما استفاده می‌شود و فروخته نمی‌شود. پردازش پیام‌های ربات توسط تلگرام مشمول سیاست حریم خصوصی تلگرام است (https://telegram.org/privacy).",
      },
      {
