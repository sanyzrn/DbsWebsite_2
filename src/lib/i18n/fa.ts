...
const fa = {
  ...
  seo: {
    ...
    contact: {
      ...
      description:
        "برای شروع یک پروژه یا گفت‌وگو درباره ایده، محصول دیجیتال یا یکپارچه‌سازی هوش مصنوعی با سعید در تماس باشید.",
    },
    privacy: {
      title: "حریم خصوصی | Saeed Zarrini",
      description: "سیاست حریم خصوصی وب‌سایت شخصی سعید.",
    },
    terms: {
      title: "شرایط استفاده | Saeed Zarrini",
      description: "شرایط استفاده از وب‌سایت شخصی سعید.",
    },
    notFound: {
  ...
  nav: {
    ...
    homeLinkLabel: "سعید — خانه",
    breadcrumbLabel: "مسیر صفحه",
  },
  hero: {
    person: "سعید زرینی",
    sinceLine: "طراحی و ساخت در تهران، از ۱۳۸۷",
    badge: "مهندس راهکارهای هوش مصنوعی و سازنده محصولات دیجیتال",
  ...
  expertise: {
    platesLabel: "چهار تفکیک رنگ که روی هم یک چاپ کامل می‌سازند؛ هر رنگ یک تخصص.",
    platesCaption: "مثل چاپ چهاررنگ: هر تخصص یک تفکیک رنگ است و محصول، جایی است که همه روی هم می‌نشینند.",
    kicker: "توانمندی‌ها",
  ...
  news: {
    ...
    emptyCtaArticles: "خواندن یادداشت‌ها",
    emptyCtaContact: "شروع یک پروژه",
  ...
  about: {
    ...
    studioNote: "تمام این کارها زیر چتر استودیو خلاقیت و محصول DbsStudio ادامه دارد.",
    studioAlt: "پرتره سعید با روکش داشبورد عملیات سیستم",
  },
  skills: {
    kicker: "مهارت‌ها",
  ...
  contact: {
    ...
    form: {
      ...
      phone: "تلفن",
      phonePh: "اختیاری",
      phoneHint: "اختیاری — اگر شماره‌تون رو بذارید، هماهنگی سریع‌تر انجام می‌شه.",
      company: "شرکت / سازمان",
      companyPh: "اختیاری",
      type: "نوع پروژه",
      message: "شرح پروژه",
      ...
      rateLimitedTitle: "سقف ساعتی پر شده است.",
      rateLimitedBody:
        "به سقف پیام در ساعت رسیده‌اید — بعداً دوباره تلاش کنید، یا مستقیم به {email} ایمیل بزنید.",
      fieldTooLong: "این فیلد خیلی طولانی است (حداکثر {n} نویسه).",
  ...
  footer: {
    colophon: "حروف‌چینی با آرچیوو، وزیرمتن و نوتو کوفی. طراحی و ساخت: سعید.",
    emailCta: "یا مستقیم ایمیل بزنید",
    tagline: "مهندس راهکارهای هوش مصنوعی و سازنده محصولات دیجیتال",
    studio: "استودیو محصول و خلاقیت DbsStudio",
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: "فرم تماس",
        body: "وقتی از طریق فرم تماس پیامی ارسال می‌کنید، نام، ایمیل، شماره تلفن اختیاری، متن پیام و جزئیات اختیاری پروژه به یک endpoint هم‌مبدأ (PHP) روی همین سایت ارسال می‌شود و یک اعلان متنی ساده از طریق Bale Bot API برای سعید فرستاده می‌شود. توکن ربات هرگز در باندل مرورگر قرار نمی‌گیرد. این اطلاعات فقط برای پاسخ به درخواست شما استفاده می‌شود و فروخته نمی‌شود. پردازش پیام‌های ربات توسط بله مشمول سیاست حریم خصوصی بله است (https://bale.ai).",
      },
      {
    ...
    sections: [
      {
        ...
        body: "محتوای این وب‌سایت — از جمله توضیحات پروژه‌ها، تصاویر و متن‌ها — برای معرفی خدمات و نمونه‌کارهای سعید ارائه شده است و صرفاً جنبه‌ی اطلاع‌رسانی دارد.",
      },
      {
      ...
      },
      {
        ...
        body: "این وب‌سایت و محتوای آن به همان شکل موجود («as is») ارائه می‌شود، بدون هیچ ضمانت صریح یا ضمنی. سعید مسئولیتی در قبال تصمیماتی که صرفاً بر اساس محتوای این سایت (بدون توافق رسمی) گرفته شود، نمی‌پذیرد.",
      },
      {
