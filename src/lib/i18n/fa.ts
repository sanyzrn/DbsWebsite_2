...
const fa = {
  ...
  seo: {
    ...
    news: {
      ...
      description:
        "خلاصه‌ای کوتاه و روزانه از کار میدانی — یادداشت‌های تحویل، ابزارها و تمرین هوش مصنوعی. به‌زودی.",
    },
    about: {
  ...
  news: {
    ...
    title: "خلاصهٔ روزانه",
    lead: "جریانی سبک از یادداشت‌های تحویل، ابزارها و تمرین هوش مصنوعی — نه مقاله‌های بلند.",
    body: "این بخش هنوز در حال راه‌اندازی است. وقتی فعال شود، به‌روزرسانی‌های کوتاه و پرتکرار اینجا می‌آید — جدا از یادداشت‌های بلندتر این بخش.",
    back: "بازگشت به یادداشت‌ها",
  },
  about: {
    kicker: "درباره من",
