...
const fa = {
  ...
  hero: {
    ...
    body: "من سعید زرینی هستم؛ طراح، مهندس محصول و متخصص راهکارهای هوش مصنوعی. بیش از ۱۶ سال است که با طراحی و ساختن سروکار دارم؛ از طراحی گرافیک و بسته‌بندی‌های دارویی تا طراحی تجربه‌ی کاربری، توسعه نرم‌افزار و ساخت محصولات مبتنی بر هوش مصنوعی.",
    body2:
