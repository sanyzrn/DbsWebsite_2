...
- Contact form: set `VITE_FORMSPREE_ID` for real Formspree delivery; without it, the interactive form is hidden and a static direct-email message is shown instead. Always keep the visible direct-email link.
